...
const QuizPage = () => {
    ...
    const currentSEO = SEO.find((item) => item.page === "quiz");

    return (
        <React.Fragment>
            <Helmet>
                <title>{`Quiz | ${INFO.main.title}`}</title>
            ...
            <div className="page-content">
                ...
                <div className="content-wrapper">
                    ...
                    <div className="quiz-container">
                        <div className="title quiz-title">Mis/Disinformation Quiz</div>
